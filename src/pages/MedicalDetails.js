      ...
      <div className=" mx-auto w-full md:w-screen  ">
        <div className="bg-white rounded   w-full h-full  p-4 ">
          ...
          >
              ...
              <select style ={{color:'#adad85',outline:'none',border:'none',borderRadius:'2px'}} class="border border-gray-300 h-9 mr-2  rounded-sm px-4 bg-gray-100 px-9  text-gray-600 h-10 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none">
